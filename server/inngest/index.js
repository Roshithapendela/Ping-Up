...
//inngest function to send a reminder when new connection request is added 
        ...
        await step.run('send-connection-request-mail' , async () => {
            ...
            const body = `
                     <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: 0 auto;">
                        ...
                        <p>You have a new connection request from <strong>${connection.from_user_id.full_name}</strong> - @${connection.from_user_id.username}</p>
