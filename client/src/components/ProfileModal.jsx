        ...
        <div className='max-w-2xl sm:py-6 mx-auto'>
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={e=>toast.promise(
                    ...
                    <div className=''>
                        <label className='text-sm block font-medium text-gray-700 mb-1'>Name</label>
                    ...
                    <div className=''>
                        <label className='text-sm block font-medium text-gray-700 mb-1'>Username</label>
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='please enter your user name' onChange={(e)=>setEditForm({...editForm,username:e.target.value})} value={editForm.username}/>
                    </div>

                    <div className=''>
                        <label className='text-sm block font-medium text-gray-700 mb-1'>Bio</label>
                    ...
                    <div className=''>
                        <label className='text-sm block font-medium text-gray-700 mb-1'>Location</label>
